...
- _Build:_
  ...
  - Generated TypeScript types (`supabase gen types`) committed; two clients in `lib/`: browser (anon) and server (service role, never imported into client components — add an ESLint guard comment).
