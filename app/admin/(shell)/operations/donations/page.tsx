...
export default async function DonationsPage({
  ...
  const resource = getSubmission("donations")!;
  ...
  return (
    <>
      <AdminPageHeader
        title="Donations"
        description="Donations processed through Paystack."
      />
      <OperationsTabs />
      ...
      <SubmissionList
        resource={resource}
        rows={rows}
        emptyBody="No donations yet. Donations appear here once a payment is confirmed."
      />
